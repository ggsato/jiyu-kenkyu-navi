  ...
  return (
    <div className="grid gap-4 md:grid-cols-[1.1fr_0.9fr]">
      <Card className="space-y-4">
        <div>
          <label className="field-label">今日わかったこと</label>
        ...
        <div>
          <label className="field-label">まだわからないこと</label>
        ...
        <div>
          <label className="field-label">次にやりたいこと</label>
        ...
        <div>
          <label className="field-label">前進感</label>
          <select value={signal} onChange={(event) => setSignal(event.target.value as "forward" | "same" | "harder")}>
            <option value="forward">前進した気がする</option>
            <option value="same">あまり変わらない</option>
            <option value="harder">むしろ難しくなった</option>
          </select>
        </div>
      ...
      <Card className="space-y-4">
        ...
        <p className="text-sm text-slate-600">保存すると、今の願いを続けるときの下書きが右の対応で更新されます。</p>
        {[
          {
            title: "今できていること",
